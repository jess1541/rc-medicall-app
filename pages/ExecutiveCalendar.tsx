                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <DatePicker 
                                    ...
                                    locale="es"
                                    className="w-full pl-10 border border-slate-200 bg-white rounded-xl p-3 text-sm font-bold focus:ring-2 focus:ring-blue-500 outline-none cursor-pointer uppercase"
